...
# найдётся ещё одна пропущенная станция.
#
# Тот же баг повторился ещё раз с "Шилка-товарная": машинист поправил — она физически лежит
# МЕЖДУ Казаново (км6428) и Холбоном (км6458), то есть внутри уже разобранного участка
# Карымская — Чернышевск (км6295-6587), а вовсе не "за Чернышевском" на неразобранном участке
# Карымская — Чита — Шилка, как я раньше ошибочно предположил (по аналогии с прежней, тоже
# неверной, историей про Чита-1/2 — см. README шаг 32). В track_stations.json станция
# записана просто "Шилка" (без "-товарная") — добавлен алиас, как и у "Карымская (парк Д)"/
# "Чернышевск-Забайкальский" ниже. Настоящий out_of_scope — то, чего в track_stations.json нет
# вообще, и не находится по схожему имени: Чита-1/2 (тоже был ошибочный вывод — теперь в
# scope, см. README шаг 32).
LOCATION_ALIASES = {
    'Карымская (парк Д)': 'Карымская',
    'Чернышевск-Забайкальский': 'Чернышевск',
    'Шилка-товарная': 'Шилка',
    'Шилка-товарная, парк П': 'Шилка',
}
